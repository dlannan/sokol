...
if [ "${PLATFORM}" = "linux" ]; then
    ...
    g++ -c -I./ -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -DTARGET_OS_IPHONE -D__APPLE__ -DSOKOL_GLCORE lib/sokol-dll.c -o ./bin/sokol_dll_macos.so -lpthread -ldl -lm 
elif [ "${PLATFORM}" = "ios64" ]; then
    g++ -c -I./ -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -D__APPLE__ -DSOKOL_GLCORE lib/sokol-dll.c -o ./bin/sokol_dll_ios64.so -lpthread -ldl -lm 
