...
if [ "${PLATFORM}" = "linux" ]; then
    ...
    gcc -c -I./ -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -DSOKOL_GLCORE lib/sokol-shapoe-dll.c -o ./bin/sokol_shape_dll.so -lpthread -ldl -lm 
    ...
    g++ -c -xobjective-c++ -I./ -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -DTARGET_OS_IPHONE -D__APPLE__ -DSOKOL_GLCORE lib/sokol-shape-dll.c -o ./bin/sokol_shape_dll_macos.so -lpthread -ldl -lm 
    ...
    g++ -c -xobjective-c++ -I./ -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -D__APPLE__ -DSOKOL_GLCORE lib/sokol-shape-dll.c -o ./bin/sokol_shape_dll_ios64.so -lpthread -ldl -lm 
