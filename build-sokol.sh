...
if [ "${PLATFORM}" = "linux" ]; then
    ...
    gcc -c -I./ -I./util -I../lib/nuklear -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -DSOKOL_GLCORE lib/nuklear/nuklear.c lib/sokol-nuklear-dll.c -o ./bin/sokol_nuklear_dll.so -lpthread -ldl -lm 
    ...
    g++ -c -xobjective-c++ -I./ -I./util -I./lib/nuklear -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -DTARGET_OS_IPHONE -D__APPLE__ -DSOKOL_GLCORE lib/nuklear/nuklear.c lib/sokol-nuklear-dll.c -o ./bin/sokol_nuklear_dll_macos.so -lpthread -ldl -lm 
    ...
    g++ -c -xobjective-c++ -I./ -I./lib/nuklear -I./util -I/usr/include -L/usr/include -I/usr/local/include -L/usr/local/include -D__APPLE__ -DSOKOL_GLCORE lib/nuklear/nuklear.c lib/sokol-nuklear-dll.c -o ./bin/sokol_nuklear_dll_ios64.so -lpthread -ldl -lm 
